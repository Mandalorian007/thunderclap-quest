...
export async function execute(interaction: CommandInteraction) {
  ...
  try {
    ...
    // Generate gear using existing helper (import dynamically)
    const rewardHelpers = await import('../../../convex/convex/helpers/rewardHelpers');
    const gearData = rewardHelpers.generateSampleGear(player.level, slot as any);
